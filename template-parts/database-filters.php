...
<div class="character-skills container">
  ...
  <?php
    ...
    $tags_to_exclude = array('Tier 0', 'Tier 0.5', 'Tier 1', 'Tier 1.5', 'Tier 2', 'Tier 2.5', 'Tier 3', 'R', 'SR', 'SSR', 'UR', 'Abnormal', 'Pilgrim', 'Elysion', 'Tetra', 'Missilis', 'Fire', 'Wind', 'Water', 'Iron', 'Electric', 'Light', 'Dark', 'Shotgun', 'SMG', 'Machine gun', 'Assault rifle', 'Rocket Launcher', 'Sniper Rifle', 'Burst 1', 'Burst 2', 'Burst 3', 'Burst All', 'Attacker', 'Defender', 'Supporter', 'Plant', 'Middle row', 'Back row', 'Front row', 'Physical Damage', 'Magical Damage', 'Broken' );
